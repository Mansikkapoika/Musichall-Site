...
-- -----------------------------------------------------
-- Table `musichall`.`Location`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `musichall`.`Location` (
...
-- -----------------------------------------------------
-- Table `musichall`.`ligneLoc`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `musichall`.`ligneLoc` (
  `idLocation` INT NOT NULL,
  `idMateriel` INT NOT NULL,
  ...
  CONSTRAINT `fk_ligneLoc_Location1`
    ...
    REFERENCES `musichall`.`Location` (`idLocation`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
