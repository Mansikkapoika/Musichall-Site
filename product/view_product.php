							...
							<ul id="etalage">
								<li>
									<a href="optionallink.html">
										<img class="etalage_thumb_image" src="../<?= $getMat['cheminImage']; ?>" />
										<img class="etalage_source_image" src="../<?= $getMat['cheminImage']; ?>" title="" />
									</a>
								</li>
								<li>
									<img class="etalage_thumb_image" src="../<?= $getMat['cheminImage']; ?>"  />
								...
								<li>
									<img class="etalage_thumb_image" src="../<?= $getMat['cheminImage']; ?>"  />
									<img class="etalage_source_image" src="../<?= $getMat['cheminImage']; ?>" />
								</li>
					...
					<ul class="popular-products">
						...
						<li>
							...
							<div class="price-details">
								...
								<div class="add-cart">								
									<h4><a href="?souscat=<?= $item['idSousCategorie']; ?>&mat=<?php echo $item['idMateriel']; ?>">Plus d'infos</a></h4>
								</div>
								<div class="clear"></div>
							</div>					 
						</li>
